  ...
  cwieDataStore
    ...
    .then(async (response) => {
      ...
      if (response.data.message == "success") {
        ...
        fetchVisits();
        // visit.value.form_id = formItem.value.id;
        // visit.value.address = formItem.value.workplace_address;
        // visit.value.googlemap_url = formItem.value.workplace_googlemap_url;
        ...
        // visit.value.type = formItem.value.visit_type;
        // visit.value.visit_date = formItem.value.visit_date;
        // visit.value.visit_time = formItem.value.visit_time;
        // visit.value.co_name = formItem.value.co_name;
        // visit.value.co_position = formItem.value.co_position;
  ...
  cwieDataStore
    ...
    .then(async (response) => {
      ...
      if (response.data.message == "success") {
        ...
        visit.value.address = visitItem.workplace_address;
        visit.value.googlemap_url = visitItem.workplace_googlemap_url;
        visit.value.province_id = visitItem.workplace_province_id;
        visit.value.amphur_id = visitItem.workplace_amphur_id;
        visit.value.tumbol_id = visitItem.workplace_tumbol_id;
        visit.value.type = {
