            ...
            <VRow>
              ...
              >
                <label
                  class="v-label"
                  for="address"
                > ที่อยู่ออกนิเทศ </label>
                <AppTextField
                  id="address"
                  v-model="visit.address"
                />
              </VCol>
