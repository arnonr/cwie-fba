  ...
  <VRow v-if="checkoutCartDataLocal">
    <VCol cols="12" md="8">
      ...
      <VAlert color="success" variant="tonal">
        <template #prepend>
          <VIcon size="34" icon="tabler-bookmarks" />
        </template>

        <VAlertTitle class="text-success mb-3"> Available Offers </VAlertTitle>
          ...
          >
            ...
            >
              ...
              >
                ...
                <div>
                  <VBtn variant="tonal"> move to wishlist </VBtn>
                </div>
              </div>
            </div>
          </div>
    ...
    <VCol cols="12" md="4">
      <VCard flat variant="outlined">
        <!-- 👉 payment offer -->
        <VCardText>
          <h6 class="text-base font-weight-medium mb-3">Offer</h6>
          ...
          <div class="d-flex align-center gap-4">
            ...
            <VBtn variant="tonal" @click="updateCartData"> Apply </VBtn>
          </div>
