...
class VisitController extends Controller
{
    ...
    public function getAll(Request $request)
    {
        ...
        if ($request->includeAll) {
            ...
            $items->leftJoin("form", "form.id", "=", "visit.form_id");
        ...
        if ($request->visit_reject_status_id) {
            $items->where('visit.visit_reject_status_id', $request->visit_reject_status_id);
        }
    ...
    public function get($id)
    {
        ...
        ->leftJoin("province","province.province_id","=","visit.province_id")
    ...
    public function add(Request $request)
    {
        ...
        $pathMap = null;
        if ($request->googlemap_file != "" && $request->googlemap_file != "null" &&$request->googlemap_file != "undefined") {
            $fileMap = date("YmdHis")."_visit_map_" .rand(1, 10000) ."." .$request->file("googlemap_file")->extension();
